...
// Verbatim copy (Lucas, 2026-07-11) — do not reword. Blank lines between
// paragraphs are part of the approved format and must survive copy/paste.
export function dmTemplate(first) {
  const greet = first ? `Hey ${first}!` : "Hey!";
  return `${greet} I'm Lucas (also Known as The Exam Planner on Tik Tok) and I'm running Growth for Anara atm. Our website helps university students, grad students and researchers find, understand and write papers faster.
