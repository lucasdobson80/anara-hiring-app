...
// Welcome email as an editable template ({first} token). Links are baked in
// at module load; the copy is the default until an account edits their own.
export const DEFAULT_WELCOME_EMAIL = `Subject: {first}, welcome to the Anara growth team!
...
// The message bank every account starts with — each entry is editable, and
// accounts can add their own custom snippets on top. These names are the
...
export const DEFAULT_MESSAGE_NAMES = ["Outreach DM", "Follow-up bump", "Welcome email"];
