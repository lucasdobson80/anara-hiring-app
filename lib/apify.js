...
export async function startRun({ hashtags, searchQueries, resultsPerPage, days, maxItems }) {
  ...
  if (searchQueries?.length) {
    ...
    input.videoSearchDateFilter = days <= 7 ? "THIS_WEEK" : days <= 31 ? "THIS_MONTH" : "ALL_TIME";
  }
...
export function aggregateCandidates(items, { days, minFollowers = 1000, maxFollowers = 150000 }) {
