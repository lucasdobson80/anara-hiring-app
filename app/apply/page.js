  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch("/api/apply", {
        ...
        body: JSON.stringify({ name, link, email, portfolio, country, community, website: "" }),
      });
    ...
    <div className="desk apply-page">
      <div className="apply-card card">
        <div className="apply-brand">
          <span className="workspace-mark" aria-hidden>A</span>
        ...
        {done ? (
          <>
            ...
            <p className="soft apply-sub">
              Thanks — we&apos;ve got your details and we&apos;ll take a look at your profile.
              If it&apos;s a fit, we&apos;ll reach out by email or DM within a few days.
            </p>
          </>
        ) : (
          <>
            <h1 className="apply-title">Create for Anara</h1>
            <p className="soft apply-sub">
              Anara (anara.com) pays UGC creators per video for short-form content.
              Tell us where to find your work and we&apos;ll be in touch.
            </p>
